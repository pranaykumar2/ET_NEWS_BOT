...
class EnhancedNewsImageGenerator:
    ...
    def __init__(self,
        ...
        self.font_title_family = 'Fraunces'         # Editorial excellence
        self.font_body_family = 'Inter'             # Perfect readability
        self.font_meta_family = 'Inter'             # Clean metadata
        self.font_brand_family = 'Inter'            # Professional branding

        self.font_title_style = '900'               # Black weight for impact
        self.font_body_style = '400'
        self.font_meta_style = '700'                # Bold for badges
        self.font_brand_style = '500'

        # Perfect Scale
        self.font_badge_size = 18                   # Perfect badge text
        self.font_title_size = 56                   # Commanding
        self.font_body_size = 28                    # Comfortable
        self.font_brand_size = 13
        self.font_meta_size = 14

        # Optical Line Heights
        self.title_line_height = 72
        self.body_line_height = 42
    ...
    def generate_news_image(self, title, description="", timestamp="", image_data: Optional[bytes] = None):
        ...
        badge_text = "LIVE MARKET UPDATES"
